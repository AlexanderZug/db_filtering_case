...
class IndexView(CreateView):
    ...
    def form_valid(self, form):
        ...
        if filtered_time_query_set()['query'](instance):
            messages.success(
                self.request,
                result_to_output_all_data(
                    filtered_time_query_set()['query'](instance)
                ),
            )
            ...
            messages.success(
                self.request,
                result_to_output_without_hour(
                    filtered_time_query_set()['hour'](instance)
                ),
            )
            ...
            messages.success(
                self.request,
                result_to_output_without_day(
                    filtered_time_query_set()['day'](instance)
                ),
            )
            ...
            messages.success(
                self.request,
                result_to_output_without_month(
                    filtered_time_query_set()['month'](instance)
                ),
            )
        else:
            messages.success(
                self.request,
                result_to_output_without_year(
                    filtered_time_query_set()['year'](instance)
                ),
            )
